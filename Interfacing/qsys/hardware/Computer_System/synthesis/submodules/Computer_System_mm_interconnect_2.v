...
module Computer_System_mm_interconnect_2 (
		...
		output wire        Filter_0_lw_write,                                     //                                     Filter_0_lw.write
		output wire        Filter_0_lw_read,                                      //                                                .read
		input  wire [31:0] Filter_0_lw_readdata,                                  //                                                .readdata
		output wire [31:0] Filter_0_lw_writedata,                                 //                                                .writedata
	...
	wire   [31:0] filter_0_lw_agent_m0_readdata;                                               // Filter_0_lw_translator:uav_readdata -> Filter_0_lw_agent:m0_readdata
	wire          filter_0_lw_agent_m0_waitrequest;                                            // Filter_0_lw_translator:uav_waitrequest -> Filter_0_lw_agent:m0_waitrequest
	wire          filter_0_lw_agent_m0_debugaccess;                                            // Filter_0_lw_agent:m0_debugaccess -> Filter_0_lw_translator:uav_debugaccess
	wire   [20:0] filter_0_lw_agent_m0_address;                                                // Filter_0_lw_agent:m0_address -> Filter_0_lw_translator:uav_address
	wire    [3:0] filter_0_lw_agent_m0_byteenable;                                             // Filter_0_lw_agent:m0_byteenable -> Filter_0_lw_translator:uav_byteenable
	wire          filter_0_lw_agent_m0_read;                                                   // Filter_0_lw_agent:m0_read -> Filter_0_lw_translator:uav_read
	wire          filter_0_lw_agent_m0_readdatavalid;                                          // Filter_0_lw_translator:uav_readdatavalid -> Filter_0_lw_agent:m0_readdatavalid
	wire          filter_0_lw_agent_m0_lock;                                                   // Filter_0_lw_agent:m0_lock -> Filter_0_lw_translator:uav_lock
	wire   [31:0] filter_0_lw_agent_m0_writedata;                                              // Filter_0_lw_agent:m0_writedata -> Filter_0_lw_translator:uav_writedata
	wire          filter_0_lw_agent_m0_write;                                                  // Filter_0_lw_agent:m0_write -> Filter_0_lw_translator:uav_write
	wire    [2:0] filter_0_lw_agent_m0_burstcount;                                             // Filter_0_lw_agent:m0_burstcount -> Filter_0_lw_translator:uav_burstcount
	wire          filter_0_lw_agent_rf_source_valid;                                           // Filter_0_lw_agent:rf_source_valid -> Filter_0_lw_agent_rsp_fifo:in_valid
	wire  [118:0] filter_0_lw_agent_rf_source_data;                                            // Filter_0_lw_agent:rf_source_data -> Filter_0_lw_agent_rsp_fifo:in_data
	wire          filter_0_lw_agent_rf_source_ready;                                           // Filter_0_lw_agent_rsp_fifo:in_ready -> Filter_0_lw_agent:rf_source_ready
	wire          filter_0_lw_agent_rf_source_startofpacket;                                   // Filter_0_lw_agent:rf_source_startofpacket -> Filter_0_lw_agent_rsp_fifo:in_startofpacket
	wire          filter_0_lw_agent_rf_source_endofpacket;                                     // Filter_0_lw_agent:rf_source_endofpacket -> Filter_0_lw_agent_rsp_fifo:in_endofpacket
	wire          filter_0_lw_agent_rsp_fifo_out_valid;                                        // Filter_0_lw_agent_rsp_fifo:out_valid -> Filter_0_lw_agent:rf_sink_valid
	wire  [118:0] filter_0_lw_agent_rsp_fifo_out_data;                                         // Filter_0_lw_agent_rsp_fifo:out_data -> Filter_0_lw_agent:rf_sink_data
	wire          filter_0_lw_agent_rsp_fifo_out_ready;                                        // Filter_0_lw_agent:rf_sink_ready -> Filter_0_lw_agent_rsp_fifo:out_ready
	wire          filter_0_lw_agent_rsp_fifo_out_startofpacket;                                // Filter_0_lw_agent_rsp_fifo:out_startofpacket -> Filter_0_lw_agent:rf_sink_startofpacket
	wire          filter_0_lw_agent_rsp_fifo_out_endofpacket;                                  // Filter_0_lw_agent_rsp_fifo:out_endofpacket -> Filter_0_lw_agent:rf_sink_endofpacket
	wire          filter_0_lw_agent_rdata_fifo_src_valid;                                      // Filter_0_lw_agent:rdata_fifo_src_valid -> Filter_0_lw_agent_rdata_fifo:in_valid
	wire   [33:0] filter_0_lw_agent_rdata_fifo_src_data;                                       // Filter_0_lw_agent:rdata_fifo_src_data -> Filter_0_lw_agent_rdata_fifo:in_data
	wire          filter_0_lw_agent_rdata_fifo_src_ready;                                      // Filter_0_lw_agent_rdata_fifo:in_ready -> Filter_0_lw_agent:rdata_fifo_src_ready
	...
	wire          filter_0_lw_agent_rp_valid;                                                  // Filter_0_lw_agent:rp_valid -> router_006:sink_valid
	wire  [117:0] filter_0_lw_agent_rp_data;                                                   // Filter_0_lw_agent:rp_data -> router_006:sink_data
	wire          filter_0_lw_agent_rp_ready;                                                  // router_006:sink_ready -> Filter_0_lw_agent:rp_ready
	wire          filter_0_lw_agent_rp_startofpacket;                                          // Filter_0_lw_agent:rp_startofpacket -> router_006:sink_startofpacket
	wire          filter_0_lw_agent_rp_endofpacket;                                            // Filter_0_lw_agent:rp_endofpacket -> router_006:sink_endofpacket
	...
	wire    [9:0] cmd_mux_002_src_channel;                                                     // cmd_mux_002:src_channel -> VGA_Subsystem_char_buffer_control_slave_burst_adapter:sink0_channel
	...
	wire          cmd_mux_004_src_valid;                                                       // cmd_mux_004:src_valid -> Filter_0_lw_burst_adapter:sink0_valid
	wire  [117:0] cmd_mux_004_src_data;                                                        // cmd_mux_004:src_data -> Filter_0_lw_burst_adapter:sink0_data
	wire          cmd_mux_004_src_ready;                                                       // Filter_0_lw_burst_adapter:sink0_ready -> cmd_mux_004:src_ready
	wire    [9:0] cmd_mux_004_src_channel;                                                     // cmd_mux_004:src_channel -> Filter_0_lw_burst_adapter:sink0_channel
	wire          cmd_mux_004_src_startofpacket;                                               // cmd_mux_004:src_startofpacket -> Filter_0_lw_burst_adapter:sink0_startofpacket
	wire          cmd_mux_004_src_endofpacket;                                                 // cmd_mux_004:src_endofpacket -> Filter_0_lw_burst_adapter:sink0_endofpacket
	wire          filter_0_lw_burst_adapter_source0_valid;                                     // Filter_0_lw_burst_adapter:source0_valid -> Filter_0_lw_agent:cp_valid
	wire  [117:0] filter_0_lw_burst_adapter_source0_data;                                      // Filter_0_lw_burst_adapter:source0_data -> Filter_0_lw_agent:cp_data
	wire          filter_0_lw_burst_adapter_source0_ready;                                     // Filter_0_lw_agent:cp_ready -> Filter_0_lw_burst_adapter:source0_ready
	wire    [9:0] filter_0_lw_burst_adapter_source0_channel;                                   // Filter_0_lw_burst_adapter:source0_channel -> Filter_0_lw_agent:cp_channel
	wire          filter_0_lw_burst_adapter_source0_startofpacket;                             // Filter_0_lw_burst_adapter:source0_startofpacket -> Filter_0_lw_agent:cp_startofpacket
	wire          filter_0_lw_burst_adapter_source0_endofpacket;                               // Filter_0_lw_burst_adapter:source0_endofpacket -> Filter_0_lw_agent:cp_endofpacket
	...
	wire    [9:0] cmd_mux_005_src_channel;                                                     // cmd_mux_005:src_channel -> LEDs_s1_burst_adapter:sink0_channel
	...
	wire    [9:0] cmd_mux_006_src_channel;                                                     // cmd_mux_006:src_channel -> HEX3_HEX0_s1_burst_adapter:sink0_channel
	...
	wire    [9:0] cmd_mux_007_src_channel;                                                     // cmd_mux_007:src_channel -> Slider_Switches_s1_burst_adapter:sink0_channel
	...
	wire    [9:0] cmd_mux_008_src_channel;                                                     // cmd_mux_008:src_channel -> Pushbuttons_s1_burst_adapter:sink0_channel
	...
	wire          filter_0_lw_agent_rdata_fifo_out_valid;                                      // Filter_0_lw_agent_rdata_fifo:out_valid -> avalon_st_adapter_004:in_0_valid
	wire   [33:0] filter_0_lw_agent_rdata_fifo_out_data;                                       // Filter_0_lw_agent_rdata_fifo:out_data -> avalon_st_adapter_004:in_0_data
	wire          filter_0_lw_agent_rdata_fifo_out_ready;                                      // avalon_st_adapter_004:in_0_ready -> Filter_0_lw_agent_rdata_fifo:out_ready
	wire          avalon_st_adapter_004_out_0_valid;                                           // avalon_st_adapter_004:out_0_valid -> Filter_0_lw_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_004_out_0_data;                                            // avalon_st_adapter_004:out_0_data -> Filter_0_lw_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_004_out_0_ready;                                           // Filter_0_lw_agent:rdata_fifo_sink_ready -> avalon_st_adapter_004:out_0_ready
	wire    [0:0] avalon_st_adapter_004_out_0_error;                                           // avalon_st_adapter_004:out_0_error -> Filter_0_lw_agent:rdata_fifo_sink_error
	...
	altera_merlin_slave_translator #(
		...
		.AV_SETUP_WAIT_CYCLES           (0),
		.AV_DATA_HOLD_CYCLES            (0)
	) filter_0_lw_translator (
		.clk                    (System_PLL_sys_clk_clk),                     //                      clk.clk
		.reset                  (Filter_0_reset_reset_bridge_in_reset_reset), //                    reset.reset
		.uav_address            (filter_0_lw_agent_m0_address),               // avalon_universal_slave_0.address
		.uav_burstcount         (filter_0_lw_agent_m0_burstcount),            //                         .burstcount
		.uav_read               (filter_0_lw_agent_m0_read),                  //                         .read
		.uav_write              (filter_0_lw_agent_m0_write),                 //                         .write
		.uav_waitrequest        (filter_0_lw_agent_m0_waitrequest),           //                         .waitrequest
		.uav_readdatavalid      (filter_0_lw_agent_m0_readdatavalid),         //                         .readdatavalid
		.uav_byteenable         (filter_0_lw_agent_m0_byteenable),            //                         .byteenable
		.uav_readdata           (filter_0_lw_agent_m0_readdata),              //                         .readdata
		.uav_writedata          (filter_0_lw_agent_m0_writedata),             //                         .writedata
		.uav_lock               (filter_0_lw_agent_m0_lock),                  //                         .lock
		.uav_debugaccess        (filter_0_lw_agent_m0_debugaccess),           //                         .debugaccess
		.av_write               (Filter_0_lw_write),                          //      avalon_anti_slave_0.write
		.av_read                (Filter_0_lw_read),                           //                         .read
		.av_readdata            (Filter_0_lw_readdata),                       //                         .readdata
		.av_writedata           (Filter_0_lw_writedata),                      //                         .writedata
	...
	altera_merlin_slave_agent #(
		...
		.m0_address              (filter_0_lw_agent_m0_address),                    //              m0.address
		.m0_burstcount           (filter_0_lw_agent_m0_burstcount),                 //                .burstcount
		.m0_byteenable           (filter_0_lw_agent_m0_byteenable),                 //                .byteenable
		.m0_debugaccess          (filter_0_lw_agent_m0_debugaccess),                //                .debugaccess
		.m0_lock                 (filter_0_lw_agent_m0_lock),                       //                .lock
		.m0_readdata             (filter_0_lw_agent_m0_readdata),                   //                .readdata
		.m0_readdatavalid        (filter_0_lw_agent_m0_readdatavalid),              //                .readdatavalid
		.m0_read                 (filter_0_lw_agent_m0_read),                       //                .read
		.m0_waitrequest          (filter_0_lw_agent_m0_waitrequest),                //                .waitrequest
		.m0_writedata            (filter_0_lw_agent_m0_writedata),                  //                .writedata
		.m0_write                (filter_0_lw_agent_m0_write),                      //                .write
		.rp_endofpacket          (filter_0_lw_agent_rp_endofpacket),                //              rp.endofpacket
		.rp_ready                (filter_0_lw_agent_rp_ready),                      //                .ready
		.rp_valid                (filter_0_lw_agent_rp_valid),                      //                .valid
		.rp_data                 (filter_0_lw_agent_rp_data),                       //                .data
		.rp_startofpacket        (filter_0_lw_agent_rp_startofpacket),              //                .startofpacket
		.cp_ready                (filter_0_lw_burst_adapter_source0_ready),         //              cp.ready
		.cp_valid                (filter_0_lw_burst_adapter_source0_valid),         //                .valid
		.cp_data                 (filter_0_lw_burst_adapter_source0_data),          //                .data
		.cp_startofpacket        (filter_0_lw_burst_adapter_source0_startofpacket), //                .startofpacket
		.cp_endofpacket          (filter_0_lw_burst_adapter_source0_endofpacket),   //                .endofpacket
		.cp_channel              (filter_0_lw_burst_adapter_source0_channel),       //                .channel
		.rf_sink_ready           (filter_0_lw_agent_rsp_fifo_out_ready),            //         rf_sink.ready
		.rf_sink_valid           (filter_0_lw_agent_rsp_fifo_out_valid),            //                .valid
		.rf_sink_startofpacket   (filter_0_lw_agent_rsp_fifo_out_startofpacket),    //                .startofpacket
		.rf_sink_endofpacket     (filter_0_lw_agent_rsp_fifo_out_endofpacket),      //                .endofpacket
		.rf_sink_data            (filter_0_lw_agent_rsp_fifo_out_data),             //                .data
		.rf_source_ready         (filter_0_lw_agent_rf_source_ready),               //       rf_source.ready
		.rf_source_valid         (filter_0_lw_agent_rf_source_valid),               //                .valid
		.rf_source_startofpacket (filter_0_lw_agent_rf_source_startofpacket),       //                .startofpacket
		.rf_source_endofpacket   (filter_0_lw_agent_rf_source_endofpacket),         //                .endofpacket
		.rf_source_data          (filter_0_lw_agent_rf_source_data),                //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_004_out_0_ready),               // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_004_out_0_valid),               //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_004_out_0_data),                //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_004_out_0_error),               //                .error
		.rdata_fifo_src_ready    (filter_0_lw_agent_rdata_fifo_src_ready),          //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (filter_0_lw_agent_rdata_fifo_src_valid),          //                .valid
		.rdata_fifo_src_data     (filter_0_lw_agent_rdata_fifo_src_data),           //                .data
		.m0_response             (2'b00),                                           //     (terminated)
		.m0_writeresponsevalid   (1'b0)                                             //     (terminated)
	);
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) filter_0_lw_agent_rsp_fifo (
		.clk               (System_PLL_sys_clk_clk),                       //       clk.clk
		.reset             (Filter_0_reset_reset_bridge_in_reset_reset),   // clk_reset.reset
		.in_data           (filter_0_lw_agent_rf_source_data),             //        in.data
		.in_valid          (filter_0_lw_agent_rf_source_valid),            //          .valid
		.in_ready          (filter_0_lw_agent_rf_source_ready),            //          .ready
		.in_startofpacket  (filter_0_lw_agent_rf_source_startofpacket),    //          .startofpacket
		.in_endofpacket    (filter_0_lw_agent_rf_source_endofpacket),      //          .endofpacket
		.out_data          (filter_0_lw_agent_rsp_fifo_out_data),          //       out.data
		.out_valid         (filter_0_lw_agent_rsp_fifo_out_valid),         //          .valid
		.out_ready         (filter_0_lw_agent_rsp_fifo_out_ready),         //          .ready
		.out_startofpacket (filter_0_lw_agent_rsp_fifo_out_startofpacket), //          .startofpacket
		.out_endofpacket   (filter_0_lw_agent_rsp_fifo_out_endofpacket),   //          .endofpacket
		.csr_address       (2'b00),                                        // (terminated)
		.csr_read          (1'b0),                                         // (terminated)
		.csr_write         (1'b0),                                         // (terminated)
		.csr_readdata      (),                                             // (terminated)
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) filter_0_lw_agent_rdata_fifo (
		.clk               (System_PLL_sys_clk_clk),                     //       clk.clk
		.reset             (Filter_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
		.in_data           (filter_0_lw_agent_rdata_fifo_src_data),      //        in.data
		.in_valid          (filter_0_lw_agent_rdata_fifo_src_valid),     //          .valid
		.in_ready          (filter_0_lw_agent_rdata_fifo_src_ready),     //          .ready
		.out_data          (filter_0_lw_agent_rdata_fifo_out_data),      //       out.data
		.out_valid         (filter_0_lw_agent_rdata_fifo_out_valid),     //          .valid
		.out_ready         (filter_0_lw_agent_rdata_fifo_out_ready),     //          .ready
		.csr_address       (2'b00),                                      // (terminated)
		.csr_read          (1'b0),                                       // (terminated)
		.csr_write         (1'b0),                                       // (terminated)
		.csr_readdata      (),                                           // (terminated)
	...
	Computer_System_mm_interconnect_2_router_002 router_006 (
		.sink_ready         (filter_0_lw_agent_rp_ready),                 //      sink.ready
		.sink_valid         (filter_0_lw_agent_rp_valid),                 //          .valid
		.sink_data          (filter_0_lw_agent_rp_data),                  //          .data
		.sink_startofpacket (filter_0_lw_agent_rp_startofpacket),         //          .startofpacket
		.sink_endofpacket   (filter_0_lw_agent_rp_endofpacket),           //          .endofpacket
		.clk                (System_PLL_sys_clk_clk),                     //       clk.clk
		.reset              (Filter_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	altera_merlin_burst_adapter #(
		...
		.source0_valid         (filter_0_lw_burst_adapter_source0_valid),         //   source0.valid
		.source0_data          (filter_0_lw_burst_adapter_source0_data),          //          .data
		.source0_channel       (filter_0_lw_burst_adapter_source0_channel),       //          .channel
		.source0_startofpacket (filter_0_lw_burst_adapter_source0_startofpacket), //          .startofpacket
		.source0_endofpacket   (filter_0_lw_burst_adapter_source0_endofpacket),   //          .endofpacket
		.source0_ready         (filter_0_lw_burst_adapter_source0_ready)          //          .ready
	);
	...
	Computer_System_mm_interconnect_1_avalon_st_adapter_003 #(
		...
		.in_0_data      (filter_0_lw_agent_rdata_fifo_out_data),      //     in_0.data
		.in_0_valid     (filter_0_lw_agent_rdata_fifo_out_valid),     //         .valid
		.in_0_ready     (filter_0_lw_agent_rdata_fifo_out_ready),     //         .ready
